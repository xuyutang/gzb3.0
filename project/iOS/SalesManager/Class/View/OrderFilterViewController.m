...
-(void)layoutSubviews{
    ...
    _txtName.width = MAINWIDTH - _txtName.x - 20;
    _txtFormTime.width = MAINWIDTH -_txtFormTime.x - 20;
    _txtEndTime.width = MAINWIDTH - _txtEndTime.x - 20;
    if (iPhoneX) {
        _lab_l.x =  _txtEndTime.width/2 + 50;
