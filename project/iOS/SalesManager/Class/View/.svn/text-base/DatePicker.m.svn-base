...
{
    self = [super initWithFrame:CGRectMake(0, 0, MAINWIDTH, 260)];
    if (self) {
        // Initialization code
        ...
        */
        ...
        UIToolbar * topView = [[UIToolbar alloc]initWithFrame:CGRectMake(0, 0, MAINWIDTH, 44)];
        ...
        UIPickerView* hourPickerTemp = [[UIPickerView alloc] initWithFrame:CGRectMake(MAINWIDTH - 120, 44, 60, 216)];
        [self setHourPicker:hourPickerTemp];
        [hourPickerTemp release];
        [self.hourPicker setFrame:CGRectMake(MAINWIDTH -120, 44, 60, 216)];
        
        UIPickerView* minutesPickerTemp = [[UIPickerView alloc] initWithFrame:CGRectMake(MAINWIDTH - 80, 44, 60, 216)];
        [self setMinutePicker:minutesPickerTemp];
        [minutesPickerTemp release];
        [self.minutePicker setFrame:CGRectMake(MAINWIDTH - 80, 44, 60, 216)];
