...
-(instancetype)initWithFrame:(CGRect) frame{
    if (self = [super init]) {
        ...
        r.origin.y = self.scrollView.frame.size.height + self.scrollView.frame.origin.y + 10;
        _btnSearch.frame = r;
        _btnSearch.x = MAINWIDTH - _btnSearch.width - 15;
        _txtBarCode.width = MAINWIDTH - _txtBarCode.x - 19;
        _txtProdName.width = MAINWIDTH - _txtProdName.x - 19;
        _txtPriceStart.width = _txtPriceEnd.width = (MAINWIDTH - _txtPriceStart.x - 19 - 30)/2;//        _lab.x = _txtPriceStart.x + _txtPriceStart.width;
        _txtPriceEnd.x = _txtPriceStart.x + _txtPriceStart.width + 30;
        _txtPriceEnd.width = MAINWIDTH - _txtPriceEnd.x - 19;

        _lab.x = _txtPriceStart.x + _txtPriceStart.width + 10;
