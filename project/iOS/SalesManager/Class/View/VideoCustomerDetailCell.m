...
-(void)setVideo:(VideoTopic *)video{
    ...
    _videoDuration.x = MAINWIDTH - _videoDuration.width - 8;
    ...
    _videoSize.x = MAINWIDTH - _videoSize.width - 8;
    ...
    _address.text = addr;
    _address.width = MAINWIDTH -_address.x - 8;
    //缓存地址
    NSString *cacheAddr = @"";
    ...
    _cacheAddress.width = MAINWIDTH -_cacheAddress.x - 8;
