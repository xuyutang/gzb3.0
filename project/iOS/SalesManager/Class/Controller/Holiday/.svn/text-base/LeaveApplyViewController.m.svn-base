...
- (void)viewDidLoad {
    ...
    UIImageView *saveImageView = [[UIImageView alloc] initWithFrame:CGRectMake(60, 10, 50, 30)];
...
-(void)createUI {
    ...
    contentLabel = [[UILabel alloc]initWithFrame:CGRectMake(85, Y-3, MAINWIDTH - 80, 30)];
    ...
    contentLabel2 = [[UILabel alloc]initWithFrame:CGRectMake(85, endTimeLabel.y - 3, MAINWIDTH - 80, 30)];
