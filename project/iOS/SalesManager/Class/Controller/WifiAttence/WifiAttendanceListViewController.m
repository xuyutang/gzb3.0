...
- (UITableViewCell *) tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    cell.checkInAddress.width = MAINWIDTH - cell.checkInAddress.x - 30;
    ...
    if (checkInTrack.checkInTrackReplies.count > 0){
        ...
        cell.btApprove.x = MAINWIDTH - cell.btApprove.width - 15;
...
-(void)didReceiveMessage:(id)message {
    ...
    if ((INT_ACTIONTYPE(cr.type) == ActionTypeCheckinTrackList) || (INT_ACTIONCODE(cr.code) != ActionCodeDone)){
        [self.pullTableView reloadData];
