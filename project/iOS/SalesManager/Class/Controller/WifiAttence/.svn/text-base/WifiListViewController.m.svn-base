...
- (void)viewDidLoad {
    ...
    UIImageView *addImageView = [[UIImageView alloc] initWithFrame:CGRectMake(100, 10, 25, 25)];
...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    wifiCell.wifiSwichImageView.x = MAINWIDTH -  wifiCell.wifiSwichImageView.width - 15;
