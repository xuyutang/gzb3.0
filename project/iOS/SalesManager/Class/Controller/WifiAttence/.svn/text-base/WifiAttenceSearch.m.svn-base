...
-(void)layoutSubviews{
    ...
    _searchBtn.x = MAINWIDTH - _searchBtn.width - 15;
    _nameField.width = MAINWIDTH - _nameField.x - 19;

    _catagoryField.width = MAINWIDTH - _catagoryField.x - 19;
    _startField.width = MAINWIDTH - _startField.x - 19;
    _endField.width = MAINWIDTH - _endField.x - 19;
