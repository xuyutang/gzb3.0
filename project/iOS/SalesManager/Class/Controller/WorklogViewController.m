...
- (void)viewDidLoad
{
    ...
    UIImageView *listImageView = [[UIImageView alloc] initWithFrame:CGRectMake(100, 10, 25, 25)];
...
//    [listImageView setTextAlignment:UITextAlignmentCenter];
    ...
    [tapGesture1 release];
       ...
       UIImageView *saveImageView = [[UIImageView alloc] initWithFrame:CGRectMake(60, 10, 25, 25)];
    ...
    tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, MAINWIDTH, MAINHEIGHT) style:UITableViewStyleGrouped];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.section == 0) {
        ...
        tvTodayCell.textView.width = MAINWIDTH - 30;
        ...
        tvTomorrowCell.textView.width = MAINWIDTH - 30;
        ...
        tvQuestionCell.textView.width = MAINWIDTH - 30;
        [topView setItems:buttonsArray];
