...
-(void) initView{
    ...
    CGRect r;
    if (iPhoneX) {
          r = CGRectMake(0,90 , MAINWIDTH, SCREENHEIGHT - 216);
    }else {
         r = CGRectMake(0,90 , MAINWIDTH, MAINHEIGHT - 90);
    }
    ...
    //重置webview 大小
    if (iPhoneX) {
         self.webView.frame = CGRectMake(0, 90, MAINWIDTH,SCREENHEIGHT - 216);
    }else {
