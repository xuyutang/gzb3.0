...
- (void)viewDidLoad
{
    ...
    if (bNeedAll) {
        ...
        UIImageView *checkAllImageView = [[UIImageView alloc] initWithFrame:CGRectMake(100, 10, 30, 30)];
   ...
   leftImageView.image = [UIImage imageNamed:@"ab_icon_back"];
    ...
    searchBar = [[UISearchBar alloc] initWithFrame:CGRectMake(0, 0, MAINWIDTH, 44)];
