...
- (void)viewDidLoad {
    ...
    tableView = [[PullTableView alloc] initWithFrame:CGRectMake(0, 0, MAINWIDTH, MAINHEIGHT - 45) style:UITableViewStylePlain];
    ...
    UIImageView *reFreshImageView = [[UIImageView alloc] initWithFrame:CGRectMake(100, 10, 25, 25)];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    switch (indexPath.section) {
        ...
        case 2:{
            ...
            textViewCell.textView.width = MAINWIDTH - 30;
        ...
        case 3:{
            ...
            if (auditMulArray.count) {
                ...
                UILabel* lContent2 = [[UILabel alloc] initWithFrame:CGRectMake(rect2.origin.x, rect2.origin.y + 3,MAINWIDTH - rect2.origin.x - 15,height2)];
...
-(UIToolbar*)createToolbar {
    UIToolbar * topView = [[[UIToolbar alloc]initWithFrame:CGRectMake(0, 0, MAINWIDTH, 30)] autorelease];
