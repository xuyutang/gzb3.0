...
- (void)viewDidLoad {
    ...
    tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 15, MAINWIDTH, 90) style:UITableViewStylePlain];
    ...
    UILabel *tel = [[UILabel alloc] initWithFrame:CGRectMake(MAINWIDTH - 115,MAINHEIGHT - 30, 100, 25)];
    ...
    [btLogin setFrame:CGRectMake(20, 130, MAINWIDTH - 40, 40)];
