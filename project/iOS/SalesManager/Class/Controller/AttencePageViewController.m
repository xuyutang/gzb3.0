...
- (void)viewDidLoad {
    ...
    UIImageView *reFreshImageView = [[UIImageView alloc] initWithFrame:CGRectMake(60, 10, 25, 25)];
    ...
    _addWifiImageView = [[UIImageView alloc] initWithFrame:CGRectMake(15, 10, 25, 25)];
