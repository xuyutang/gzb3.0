...
-(void)initUI{
    ...
    //右上角设置
    UIImageView *freshImageView = [[UIImageView alloc] initWithFrame:CGRectMake(100, 10, 25, 25)];
    ...
    [rightView release];
    [self initMenu];
    _tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 1, MAINWIDTH, MAINHEIGHT -1) style:UITableViewStylePlain];
    ...
    if (iPhoneX) {
         [_tableView setFrame:CGRectMake(frame.origin.x, frame.origin.y,MAINWIDTH,SCREENHEIGHT - 184)];
    }else {
       [_tableView setFrame:CGRectMake(frame.origin.x, frame.origin.y,MAINWIDTH, MAINHEIGHT-50)];
    }
...
-(void)initMenu{
    ...
    top1.infoView.frame = CGRectMake(90, 0, MAINWIDTH - 90, 90);
    NSString* cAvtar = @"";
...
//    NSLog(@"haha");
    ...
    top2.infoView.frame = CGRectMake(90, 0, MAINWIDTH - 90, 90);
...
//    
    ...
    toptop = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, 91,90)];
    ...
    int scrollViewHeight = (functionItems.count/3+1)*116;
    menuView = [[NAMenuView alloc] init];
    [menuView setFrame:CGRectMake(0,0,MAINWIDTH, scrollViewHeight)];
...
- (void)createMenuItems {
    ...
    userFunc = [[LOCALMANAGER getFavFunctions] retain];
...
-(CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath{
    if (indexPath.section==0) {
        ...
        return 50;
//        if (iPhoneX) {
//            return menuView.frame.size.height + 50;
//
//        }else {
...
-(UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section{
    ...
    header.subTitle.x = MAINWIDTH - header.subTitle.width - 10;
...
//
//         [VIEWCONTROLLER create:self.parentController.navigationController ViewId:FUNC_WORKLOG Object:nil Delegate:nil NeedBack:YES];
        Function *f = userFunc[indexPath.row];
        [[CreatePage createPage] createViewControllwithFunValue:f.value navControl:self.parentController];
//        WorklogViewController *workVC = [[WorklogViewController alloc] init];
//        [self.parentController.navigationController pushViewController:workVC animated:YES];
...
//            }
        ...
        msgCell.subTitle.width = MAINWIDTH - msgCell.subTitle.x - 10;

     //  msgCell.flag.hidden = YES;
        msgCell.time.text = createDate;
        msgCell.time.width = MAINWIDTH - msgCell.time.x - 10;
