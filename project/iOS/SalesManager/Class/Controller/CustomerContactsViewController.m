...
- (void)viewDidLoad
{
    ...
    UIImageView *smsImageView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 10, 30, 30)];
    ...
    if (iPhoneX) {
      self.tableView = [[PullTableView alloc] initWithFrame:CGRectMake(0, 44, MAINWIDTH, (parentCtrl == nil)? MAINHEIGHT - 44:SCREENHEIGHT - 216) style:UITableViewStylePlain];
    }else {
       self.tableView = [[PullTableView alloc] initWithFrame:CGRectMake(0, 44, MAINWIDTH, (parentCtrl == nil)? MAINHEIGHT - 44:MAINHEIGHT - 90) style:UITableViewStylePlain];
    }
