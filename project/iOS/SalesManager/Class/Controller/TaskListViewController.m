...
//    tmpFrame.origin.y += 45;
    ...
    if (iPhoneX) {
        self.pullTableView = [[PullTableView alloc] initWithFrame:CGRectMake(0, 45, MAINWIDTH, SCREENHEIGHT - 216 ) style:UITableViewStylePlain];
    }else {
...
- (UITableViewCell *) tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    cell.btStatus.x = MAINWIDTH - cell.btStatus.width - 30;
...
//    }
    if (task.replyCount > 0) {
        cell.btComment.x = MAINWIDTH - cell.btComment.width - 35;
