...
//    [self.view addSubview:searchBar];
    ...
    if (iPhoneX) {
         tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 44, MAINWIDTH, SCREENHEIGHT- 216) style:UITableViewStylePlain];
    }else {
         tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 44, MAINWIDTH, MAINHEIGHT) style:UITableViewStylePlain];
    }
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.ivFavorate.x = MAINWIDTH - cell.ivFavorate.width - 15;
