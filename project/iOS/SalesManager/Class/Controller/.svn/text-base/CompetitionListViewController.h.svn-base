...
@interface CompetitionListViewController : BaseViewController<UITableViewDataSource,UITableViewDelegate, PullTableViewDelegate,CompetitionSearchDelegate>{
...
@property (retain, nonatomic)  PullTableView *pullTableView;
