...
@interface ApplyListViewController : BaseViewController<InputFinishDelegate,ApplySearchDelegate,UITableViewDelegate,UITableViewDataSource, PullTableViewDelegate,RefreshDelegate,QCheckBoxDelegate> {
