...
- (void)viewDidLoad
{
    ...
    [btNumber setFrame:CGRectMake(MAINWIDTH - 60, MAINHEIGHT - 30, 60, 51)];
    if (IS_IPHONE5) {
...
-(void)initTablesView{
    tableView = [[SMTableView alloc] initWithFrame:CGRectMake(0, 0, MAINWIDTH, MAINHEIGHT) style:UITableViewStylePlain];
