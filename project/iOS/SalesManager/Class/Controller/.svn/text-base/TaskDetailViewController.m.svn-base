...
- (void)viewDidLoad
{
   ...
   // [btWrite release];
    ...
    //KWPopoverView
    popCommentView = [[IMGCommentView alloc] initWithFrame:CGRectMake(0, 64, MAINWIDTH, 280)];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath :(NSIndexPath *)indexPath{
    ...
    switch (indexPath.section) {
        ...
        case 2:{
            ...
            IMGCommentDetailView *commentDetailView = [[IMGCommentDetailView alloc] initWithFrame:CGRectMake(0, 64, MAINWIDTH, 240)];
