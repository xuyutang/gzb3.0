...
@interface AuditListViewController : BaseViewController<InputFinishDelegate,ApplySearchDelegate,UITableViewDataSource,UITableViewDelegate, PullTableViewDelegate,RefreshDelegate,QCheckBoxDelegate> {
