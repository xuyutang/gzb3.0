...
-(void)createBottomBar{
    ...
    UIView *line1 = [[UIView alloc] initWithFrame:CGRectMake(0, 1, MAINWIDTH, .5f)];
   ...
   if (indexPath.section == 0) {
       ...
       txtCell.frame = CGRectMake(0, 0, _tableView.frame.size.width, size.height + 5);
        ...
        if (reply.content != nil && reply.content.length >0) {
            ...
            UILabel* lContent = [[UILabel alloc] initWithFrame:CGRectMake(rect.origin.x, rect.origin.y + 3,MAINWIDTH - rect.origin.x - 5,height)];
