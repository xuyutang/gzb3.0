...
- (void)viewDidLoad {
    [super viewDidLoad];
    self.txtCustomerName.width = MAINWIDTH - self.txtCustomerName.x - 20;
     self.txtContact.width = MAINWIDTH - self.txtContact.x - 20;
     self.txtTel.width = MAINWIDTH - self.txtTel.x - 20;
    self.btConfirm.width = MAINWIDTH - self.btConfirm.x - 18;
    self.btnLocation.width = MAINWIDTH - self.btnLocation.x - 40;
...
-(void)initView{
    ...
    UIToolbar * topView = [[UIToolbar alloc]initWithFrame:CGRectMake(0, 0, MAINWIDTH, 30)];
    ...
    pickerView = [[CategoryPickerView alloc] initWithFrame:CGRectMake(0.0, SCREENHEIGHT, MAINWIDTH, 251.0) tag:self];
...
//
    ...
    if (iPhoneX) {
        pickerView.frame = CGRectMake(0, SCREENHEIGHT-251 - 45, MAINWIDTH, 251);

    }else {
        pickerView.frame = CGRectMake(0, MAINHEIGHT-251, MAINWIDTH, 251);
...
//    }
    ...
    [UIView setAnimationCurve:UIViewAnimationCurveEaseInOut];
    [UIView setAnimationDuration:0.3];
    pickerView.frame = CGRectMake(0, SCREENHEIGHT, MAINWIDTH, 260);
    [UIView setAnimationDelegate:self];
    [UIView commitAnimations];
}
