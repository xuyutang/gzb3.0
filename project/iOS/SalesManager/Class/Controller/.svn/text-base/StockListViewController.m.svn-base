...
- (UITableViewCell *) tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.total.frame = CGRectMake(MAINWIDTH-expectSize.width-15, 7, expectSize.width, expectSize.height + 5);    cell.customer.text = stock.customer.name;
    cell.customer.textColor = [UIColor brownColor];

    cell.name.text = stock.user.realName;
    cell.updateTime.text = stock.createDate;
    cell.updateTime.x = cell.width - cell.updateTime.width - 15;
    if (iPhoneX) {
        cell.personIMg.x = cell.width - cell.updateTime.width - 25;
