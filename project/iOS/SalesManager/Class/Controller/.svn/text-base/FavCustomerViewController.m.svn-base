...
//    _searchBar.text = @" ";
    ...
    if (iPhoneX) {
         _syncBtn = [[SyncButton alloc] initWithFrame:CGRectMake(r.size.width - 110, r.size.height - 200, 40, 40 )];
    }else {
...
-(UITableViewCell *) createCellWith:(UITableView *) tableView indexPath:(NSIndexPath *) indexPath{
    ...
    customerCell.type.x = MAINWIDTH - customerCell.type.width - 15;
    ...
    customerCell.favButton.x = MAINWIDTH - customerCell.favButton.width -15;
