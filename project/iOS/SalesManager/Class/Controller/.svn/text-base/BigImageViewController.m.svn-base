...
- (void)viewDidLoad
{
    ...
    UIImageView *seachImageView = [[UIImageView alloc] initWithFrame:CGRectMake(100, 10, 30, 30)];
...
//    seachImageView.textColor = WT_RED;
    ...
    imageView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, MAINWIDTH, MAINHEIGHT)];
    if (image == nil) {
