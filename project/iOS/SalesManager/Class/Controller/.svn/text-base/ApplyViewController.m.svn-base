...
- (void)viewDidLoad {
    ...
    //保存
    UIImageView*  saveImageView = [[UIImageView alloc] initWithFrame:CGRectMake(16, 10, 25, 25)];
   ...
   //申请列表
    UIImageView *approImageView = [[UIImageView alloc] initWithFrame:CGRectMake(60, 10, 25, 25)];
    ...
    //审核列表
    UIImageView * auditImageView = [[UIImageView alloc] initWithFrame:CGRectMake(100, 10, 25, 25)];
    ...
    switch (indexPath.section) {
        ...
        case 2:{
            ...
            if (textViewCell == nil) {
                ...
                UIToolbar * topView = [[UIToolbar alloc]initWithFrame:CGRectMake(0, 0, MAINHEIGHT, 30)];
