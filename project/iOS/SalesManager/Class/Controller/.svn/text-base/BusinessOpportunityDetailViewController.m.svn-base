...
- (void) _show{
    ...
    tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, MAINWIDTH, MAINHEIGHT - 45) style:UITableViewStylePlain];
        ...
        case 0:{
            switch (indexPath.row) {
                ...
                case 2:{
                    ...
                    locationCell.lblAddress.width = MAINWIDTH - locationCell.lblAddress.x - 20;
            ...
            switch (indexPath.row) {
                case 0:{
                    ...
                    if (bizOppNameCell == nil) {
                        ...
                        [bizOppNameCell.txtField setFrame:CGRectMake(frame.origin.x, frame.origin.y, MAINWIDTH - 20, 80)];
                ...
                case 1:{
                    ...
                    if (bizOppPrincipalCell == nil) {
                        ...
                        [bizOppPrincipalCell.txtField setFrame:CGRectMake(frame.origin.x, frame.origin.y,MAINWIDTH - 20, 80)];
...
//                    break;
                case 0:{
                    ...
                    if (otherBizOppSummaryCell == nil) {
                        ...
                        [otherBizOppSummaryCell.txtField setFrame:CGRectMake(frame.origin.x, frame.origin.y, MAINWIDTH - 20, 80)];
                ...
                case 1:{
                    ...
                    if (otherBizOppDecisionCell == nil) {
                        ...
                        [otherBizOppDecisionCell.txtField setFrame:CGRectMake(frame.origin.x, frame.origin.y, MAINWIDTH - 20, 80)];
                ...
                case 2:{
                    ...
                    if (otherActionPlanCell == nil) {
                        ...
                        [otherActionPlanCell.txtField setFrame:CGRectMake(frame.origin.x, frame.origin.y,MAINWIDTH - 20, 80)];
                ...
                case 3:{
                    ...
                    if (otherExpectedCostCell == nil) {
                        ...
                        [otherExpectedCostCell.txtField setFrame:CGRectMake(frame.origin.x, frame.origin.y, MAINWIDTH - 20, 80)];
                ...
                case 4:{
                    ...
                    if (otherSignTimeCell == nil) {
                        ...
                        [otherSignTimeCell.txtField setFrame:CGRectMake(frame.origin.x, frame.origin.y,MAINWIDTH - 20, 80)];
...
//            break;
            ...
            if (textViewCell == nil) {
                ...
                [textViewCell.txtField setFrame:CGRectMake(frame.origin.x, frame.origin.y, MAINWIDTH - 20, 80)];
        ...
        case 4:{
            ...
            if (reply.content != nil && reply.content.length >0) {
                ...
                UILabel* lContent = [[UILabel alloc] initWithFrame:CGRectMake(rect.origin.x, rect.origin.y + 3,MAINWIDTH - rect.origin.x - 15,height)];
